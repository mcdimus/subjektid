...
/* Employee attributes */
INSERT INTO subject_attribute_type (subject_type_fk, type_name, data_type, orderby, required, multiple_attributes) VALUES (3, 'employee since', 3, 2, 'N', 'N');
INSERT INTO subject_attribute_type (subject_type_fk, type_name, data_type, orderby, required, multiple_attributes) VALUES (3, 'iq', 2, 3, 'N', 'N');
INSERT INTO subject_attribute_type (subject_type_fk, type_name, data_type, orderby, required, multiple_attributes) VALUES (3, 'salary', 2, 4, 'N', 'N');
INSERT INTO subject_attribute_type (subject_type_fk, type_name, data_type, orderby, required, multiple_attributes) VALUES (3, 'insured', 1, 5, 'N', 'N');
INSERT INTO subject_attribute_type (subject_type_fk, type_name, data_type, orderby, required, multiple_attributes) VALUES (3, 'first aid course', 1, 6, 'N', 'N');
